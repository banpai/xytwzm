window.apiready = function () {
  var vm = new Vue({
    ...
    methods: {
      loadList: function () {
        var url = "";
        var pingUrl = api.pageParam.eventType == 'notEnd' ? '&eventState=notbanjie' : '&eventState=banjie';
        url = UICore.serviceUrl + 'mobile/mobileWf.shtml?act=getEventAllList&accountId=' + this.accountId + '&page=' + this.page + '&rows=' + this.rows + pingUrl;
        console.log(url);
        api.ajax({
          url: url,
          tag: 'grid',
